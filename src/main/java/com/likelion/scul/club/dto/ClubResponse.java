...
public class ClubResponse {
    ...
    public ClubResponse(Long clubId, String clubName, String clubContent, String clubPlace, LocalDate clubDate, LocalDateTime createdAt, int clubTotalNumber, int clubParticipateNumber, String clubQnaLink, String clubParticipateLink, int clubCost, String clubStatus, String clubImage, String name, String sportsName) {
        this.clubId = clubId;
    ...
    public static ClubResponse toClubResponse(Club club) {
        return new ClubResponse(
                club.getClubId(), club.getClubName(), club.getClubContent(), club.getClubPlace(), club.getClubDate(), club.getCreatedAt(),
